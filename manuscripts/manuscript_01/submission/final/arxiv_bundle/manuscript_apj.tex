\documentclass[manuscript,linenumbers]{aastex702}
% AASTeX v7.0.2 submission conversion from the author-approved M1.6 source.
% Scientific prose, scientific numbers, claims, figures, and tables are frozen.
\usepackage{booktabs}
\usepackage{array}
\usepackage{tabularx}
...
\shorttitle{AFINO Robustness and Synthetic Selection}
\shortauthors{Balboa Corominas}
\begin{document}
...
\correspondingauthor{Marc Balboa Corominas}
\author[0009-0006-7571-9193,gname=Marc,sname='Balboa Corominas']{Marc Balboa Corominas}
\affiliation{Independent Researcher, Spain}
\email[show]{m.balboacorominas.research@gmail.com}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.92\textheight]{fig4.pdf}
...
% M1TRACE paragraph=M1P0072 claims=M1C001,M1C006,M1C024 sources=M1S002,M1S003,M1S030,M1S038 plane=M1EP01,M1EP04
...
\begin{sloppypar}
The scientific results in this manuscript resolve to frozen repository evidence rather than to newly computed quantities. The public AFINO baseline is package version 0.5 at repository commit \texttt{6aceac9518fc8056052807e666da9d0c8bebb010}. The TESS-QPP research repository is available at \url{https://github.com/marc-balboa-corominas/tess-qpp}; manuscript archival artifacts are mirrored in the project OSF record at \url{https://osf.io/vhktr/}. The M1.4 scientific manuscript freeze is commit \texttt{10e4ac7017950f60e74a1f0fddb41f6004f7755d} (tag \texttt{manuscript1-reviewed-draft-v1}), the definitive M1.2 visual freeze is commit \texttt{7e65987511487ea7de01d1b2880cc70687823541} (tag \texttt{manuscript1-visuals-v1}), and the authoritative submission-plan freeze is M1.5-v2 commit \texttt{e01db0ae1a47fac6de77bef7477dd119ab9f5d14} (tag \texttt{manuscript1-submission-plan-v2}). F3A and F3B are frozen under \texttt{phase3a-complete-v2} and \texttt{phase3b-complete-v1}, respectively. Machine-readable design/configuration paths and SHA-256 identities used by this author-review layer are recorded in \path{m1_6_source_bindings.json}. No DOI is asserted for resources for which a DOI has not been frozen.
\end{sloppypar}

% M1.7 submission-only metadata; no scientific content change.
The TESS fast-cadence mission data underlying the frozen observational cohort are publicly available from the Mikulski Archive for Space Telescopes (MAST). The frozen cohort is restricted to Sectors 27--80, and the corresponding 20-second light-curve collection is mapped for submission to MAST DOI \dataset[10.17909/t9-st5g-3177]{https://doi.org/10.17909/t9-st5g-3177}.

\begin{acknowledgments}
This research received no external funding. The author declares no competing interests. This research made use of public TESS data distributed by the Mikulski Archive for Space Telescopes (MAST).
\end{acknowledgments}

\facility{TESS}

\begin{contribution}
Marc Balboa Corominas: Conceptualization; Methodology; Software; Validation; Formal analysis; Investigation; Data curation; Visualization; Writing -- original draft; Writing -- review and editing; Project administration.
\end{contribution}

\bibliographystyle{aasjournalv7.1}
\bibliography{references_apj}
\end{document}
